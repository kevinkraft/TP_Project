...
%\begin{subequations}
%\begin{gather}\label{Ex2_equate_coeffs_second_a}
%, \\\label{Ex2_equate_coeffs_second_b}
% ,\\\label{Ex2_equate_coeffs_second_c}
% ,\\\label{Ex2_equate_coeffs_second_d}
%. 
%\end{gather}
%\end{subequations}
